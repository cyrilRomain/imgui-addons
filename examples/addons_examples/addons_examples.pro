...
#PKGCONFIG += freetype2
#DEFINES+=IMIMPL_USE_FONT_TEXTURE_NEAREST_FILTERING
...
#DEFINES+=NO_IMGUISTYLESERIALIZER NO_IMGUIDATETIME NO_IMGUILISTVIEW NO_IMGUIGRAPHEDITOR NO_IMGUITOOLBAR NO_IMGUIPANELMANAGER NO_IMGUIFILESYSTEM NO_IMGUICODEEDITOR NO_IMGUITABWINDOW
} #use_main6
!use_main6 {
use_main5 {
SOURCES+=main5.cpp
...
#DEFINES+=NO_IMGUISTYLESERIALIZER NO_IMGUIDATETIME NO_IMGUILISTVIEW NO_IMGUIGRAPHEDITOR NO_IMGUITOOLBAR NO_IMGUIPANELMANAGER NO_IMGUIFILESYSTEM NO_IMGUICODEEDITOR
DEFINES+=NO_IMGUIDATETIME NO_IMGUILISTVIEW NO_IMGUIGRAPHEDITOR NO_IMGUITOOLBAR NO_IMGUIPANELMANAGER NO_IMGUICODEEDITOR
DEFINES+=IMGUI_ENABLE_FREETYPE
...
DEFINES+=NO_IMGUISTYLESERIALIZER NO_IMGUIDATETIME NO_IMGUILISTVIEW NO_IMGUIGRAPHEDITOR NO_IMGUITOOLBAR NO_IMGUIPANELMANAGER
}  #use_main3
!use_main3 {
use_main2 {
SOURCES+=main2.cpp
...
#DEFINES+=IMIMPL_USE_ARB_TEXTURE_SWIZZLE_TO_SAVE_FONT_TEXTURE_MEMORY
#DEFINES+=IMIMPL_USE_ARB_TEXTURE_COMPRESSION_TO_COMPRESS_FONT_TEXTURE
#DEFINES+=YES_IMGUIADDONS_ALL
#LIBS+= -lsqlite3
#PKGCONFIG += poppler-glib
